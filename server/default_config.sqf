...
A3W_bleedingTime = 210;             // Time in seconds for which to allow revive after a critical injury (minimum 10 seconds)
...
A3W_sideMissionDelay = 6*60;       // Time in seconds between Side Missions
