...
_role1 = "Welcome to";
_role1names = ["BIB - A3Wasteland Altis"];
_role2 = "Server restarts every 4 hours";
_role2names = ["2:00, 6:00, 10:00, 14:00, 18:00, 22:00 EST"];
_role3 = "Forums and Website @";
_role3names = ["Bibgaming.com"];
_role4 = "TS3 Server @";
_role4names = ["TS3.Bibgaming.com"];
